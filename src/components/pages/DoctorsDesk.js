        ...
        <div className="col-sm-5">
          <div className="form-data">
            ...
            <div className="form-body">
              ...
              <div className="row form-row">
                <input type="text" placeholder="Notes If Applicable" className="form-control" />
              </div>
              <div className="row form-row">
                <input type="text" placeholder="Diagnosis" className="form-control" />
              </div>
              <div className="row form-row">
                <input id="dat" type="text" placeholder="Recommendation" className="form-control" />
              </div>
              <h6>Medicine</h6>
              <div className="row form-row">
